...
const AddCategoryModal = ({ onAdd, categories, onClose }) => {

    const [form, setForm] = useState({ name: '', icon: 'Apple', color: '#F2904A' })
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
                    ...
                    <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                        <h4 className="font-bold text-gray-800">Add Category</h4>
                    ...
                    <div className="px-6 py-5">
                        ...
                        <div className="grid grid-cols-6 gap-2 max-h-[200px] overflow-y-auto pr-1">
                            {Object.values(categoriesStyle).map(iconName => {
                                ...
                                const iconInCategories = categories.find(c => c.icon === iconName.icon) ? true : false
                                if (!Icon) return null
                                return (
                                    <button
                                        key={iconName.icon}
